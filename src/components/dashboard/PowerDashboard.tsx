/**
 * Power Dashboard Component
 * 전력 계통 프로젝트 목록을 표시하고 관리하는 대시보드
 * Supabase DB 연동
 */
...
const PowerDashboard: React.FC<PowerDashboardProps> = ({ userId: _userId, onLogout }) => {
