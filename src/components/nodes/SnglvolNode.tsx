/**
 * SNGLVOL Node Component
 * Single Volume for ReactFlow - Nodalization 도형 기반 렌더링
 */
...
const SnglvolNode: React.FC<NodeProps<MARSNodeData>> = ({ data, selected, id }) => {
...
export default memo(SnglvolNode);
