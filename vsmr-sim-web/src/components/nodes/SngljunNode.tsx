/**
 * SNGLJUN Node Component
 * Single Junction for ReactFlow - Nodalization 도형 기반 렌더링
 */
...
const SngljunNode: React.FC<NodeProps<MARSNodeData>> = ({ data, selected, id }) => {
...
export default memo(SngljunNode);
