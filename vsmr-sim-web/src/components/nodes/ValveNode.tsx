/**
 * VALVE Node Component
 * Motor/Trip/Servo Valve for ReactFlow - Nodalization shape-based rendering
 */
...
const ValveNode: React.FC<NodeProps<MARSNodeData>> = ({ data, selected, id }) => {
