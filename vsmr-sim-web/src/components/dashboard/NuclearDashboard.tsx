/**
 * Nuclear Dashboard Component
 * 원자력 계통 프로젝트 목록을 표시하고 관리하는 대시보드
 * Supabase DB 연동
 */
...
interface NuclearDashboardProps {
  userId: string; // Supabase Auth UUID (RLS에서 자동 처리되므로 표시용)
  onLogout: () => void;
}

const NuclearDashboard: React.FC<NuclearDashboardProps> = ({ userId: _userId, onLogout }) => {
